(self.webpackChunkCnblogs_Theme_SimpleMemory = self.webpackChunkCnblogs_Theme_SimpleMemory || []).push([[8265], {
    5478: function() {
        "object" == typeof window && (window.Ribbons = function() {
              ...
              , s = function() {
                if (1 === arguments.length) {
                    if (Array.isArray(arguments[0])) {
                        var t = Math.round(s(0, arguments[0].length - 1));
                        return arguments[0][t]
                    }
                    return s(0, arguments[0])
                }
                return 2 === arguments.length ? Math.random() * (arguments[1] - arguments[0]) + arguments[0] : 0
            }
              , o = function(s) {
                var o = Math.max(0, t.innerWidth || n.clientWidth || i.clientWidth || 0)
            ...
            return e.prototype = {
                ...
                addRibbon: function() {
                    var t = Math.round(s(1, 9)) > 5 ? "right" : "left"
                      , i = 1e3
                      , n = 200
                      , o = 0 - n
                      , e = this._width + n
                    ...
                    for (var _ = [], p = new h(l,c), d = new h(l,c), u = null, b = Math.round(s(0, 360)), f = 0; !(i <= 0); ) {
                        if (i--,
                ...
                _drawRibbonSection: function(t) {
                    if (t) {
                        ...
                        var n = this._options.colorSaturation
                          , s = this._options.colorBrightness
                          , o = "hsla(" + t.color + ", " + n + ", " + s + ", " + t.alpha + " )";
                        this._context.save(),
                ...
                _onDraw: function() {
                    ...
                    for (var n = 0; n < this._ribbons.length; ++n) {
                        for (var s = this._ribbons[n], o = s.length, h = 0, e = 0; e < o; ++e)
                            this._drawRibbonSection(s[e]) && h++;
                        h >= o && (this._ribbons[n] = null)
                    }
